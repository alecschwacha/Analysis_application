...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.button=customtkinter.CTkButton(self, text="Terrarium", command=lambda: self.terrarium_link())
...
class tab_view(customtkinter.CTkTabview):
    def __init__(self,master, **kwargs):
        ...
        self.button=customtkinter.CTkButton(master=self.tab("Drive Module"),
                                            text="IQ Current and Command Percent",
