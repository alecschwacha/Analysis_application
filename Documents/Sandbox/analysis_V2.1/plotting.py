...
def voltage_bus(dataframe, TimestampSeries): 
    ...
    plot1.plot(TimestampSeries,dataframe['/inputs/drive_outputs/axis_front_left/vbus_voltage_v'], label='/inputs/drive_outputs/axis_front_left/vbus_voltage_v')
    plot1.set_title('Voltage Front Left')
    plot1.legend()

    plot2.set_xlabel('Time')
    plot2.set_ylabel('Volts')
    plot2.plot(TimestampSeries,dataframe['/inputs/drive_outputs/axis_front_right/vbus_voltage_v'], label='/inputs/drive_outputs/axis_front_right/vbus_voltage_v')
    plot2.set_title('Voltage Front Right')
    plot2.legend()

    plot3.set_xlabel('Time') 
    plot3.set_ylabel('Volts')
    plot3.plot(TimestampSeries,dataframe['/inputs/drive_outputs/axis_rear_left/vbus_voltage_v'], label='/inputs/drive_outputs/axis_rear_left/vbus_voltage_v')
    plot3.set_title('Voltage Rear Left')
    plot3.legend()

    plot4.set_xlabel('Time')
    plot4.set_ylabel('Volts')
    plot4.plot(TimestampSeries,dataframe['/inputs/drive_outputs/axis_rear_right/vbus_voltage_v'], label='/inputs/drive_outputs/axis_rear_right/vbus_voltage_v')
...
def motor_error(dataframe, TimestampSeries):
    ...
    plot1.set_xlabel('Time')
    plot1.plot(TimestampSeries,dataframe['/inputs/drive_outputs/axis_front_left/motor_error'], label='/inputs/drive_outputs/axis_front_left/motor_error')
    plot1.set_title('Motor Error Front Left')
    plot1.set_yticklabels(plot1.get_yticklabels(), rotation=60)
    plot1.legend()

    plot2.set_xlabel('Time')
    plot2.plot(TimestampSeries,dataframe['/inputs/drive_outputs/axis_front_right/motor_error'], label='/inputs/drive_outputs/axis_front_right/motor_error')
    plot2.set_title('Motor Error Front Right')
    plot2.set_yticklabels(plot2.get_yticklabels(), rotation=60)
    plot2.legend()

    plot3.set_xlabel('Time')
    plot3.plot(TimestampSeries,dataframe['/inputs/drive_outputs/axis_rear_left/motor_error'], label='/inputs/drive_outputs/axis_rear_left/motor_error')
    plot3.set_title('Motor Error Rear Left')
    plot3.set_yticklabels(plot3.get_yticklabels(), rotation=60)
    plot3.legend()

    plot4.set_xlabel('Time')
    plot4.plot(TimestampSeries,dataframe['/inputs/drive_outputs/axis_rear_right/motor_error'], label='/inputs/drive_outputs/axis_rear_right/motor_error')
...
def disconnects(dataframe, TimestampSeries):
    ...
    plt.plot(TimestampSeries,dataframe['/inputs/brain_outputs/brain_state'], label='/inputs/brain_outputs/brain_state')
    plt.xlabel("Time")
...
def softfault_error(dataframe, TimestampSeries): 
    ...
    plot1.set_xlabel('Time')
    plot1.plot(TimestampSeries,dataframe['/inputs/drive_outputs/axis_front_left/encoder_error'], label='/inputs/drive_outputs/axis_front_left/encoder_error')
    plot1.set_title('Motor Encoder Error Front Left')
    plot1.set_yticklabels(plot1.get_yticklabels(), rotation=60)
    plot1.legend()

    plot2.set_xlabel('Time')
    plot2.plot(TimestampSeries,dataframe['/inputs/drive_outputs/axis_front_right/encoder_error'], label='/inputs/drive_outputs/axis_front_right/encoder_error')
    plot2.set_title('Motor Encoder Error Front Right')
    plot2.set_yticklabels(plot2.get_yticklabels(), rotation=60)
    plot2.legend()

    plot3.set_xlabel('Time')
    plot3.plot(TimestampSeries,dataframe['/inputs/drive_outputs/axis_rear_left/encoder_error'], label='/inputs/drive_outputs/axis_rear_left/encoder_error')
    plot3.set_title('Motor Encoder Error Rear Left')
    plot3.set_yticklabels(plot3.get_yticklabels(), rotation=60)
    plot3.legend()

    plot4.set_xlabel('Time')
    plot4.plot(TimestampSeries,dataframe['/inputs/drive_outputs/axis_rear_right/encoder_error'], label='/inputs/drive_outputs/axis_rear_right/encoder_error')
